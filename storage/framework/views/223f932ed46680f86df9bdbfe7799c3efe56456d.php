...
MyProfile ##parent-placeholder-3c6de1b7dd91465d437ef415f94f36afc1fbc8a8##
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="row" id="ddd" style="margin-top:50px;margin-left:10px;">
                                                    ...
                                                    <div class="col-sm-6">                
                                                    <img class="img-thumbnail" style="max-height: 125px;background-repeat: no-repeat;" src="<?php echo e(asset($avatar->avatar)); ?>"  >
                                                    </div>
                                                    <div class="col-sm-3"> 
                                                    </div> 
                                                </div>    
                        ...
                        <form  action="<?php echo e(route('company')); ?>" method="post" enctype="multipart/form-data" class="dropzone" id="dropzone">
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Username"  name="company_name" value="<?php echo e(($company_data)?$company_data->company_name:''); ?>" required>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Address"  name="address" value="<?php echo e(($company_data)?$company_data->address:''); ?>" required>
                                </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput"   placeholder="Contact Person" name="about" value="<?php echo e(($company_data)?$company_data->contact:''); ?>" required>
                                </div>
                                        ...
                                        <div class="col-lg-3">
                                              ...
                                              <select class="form-control" name="phone_number_code" id="exampleFormControlSelect1" required>
                                                ...
                                                <?php $__currentLoopData = $country_array; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>:
                                                    ...
                                                    <option value="<?php echo e($country['code']); ?>" data="<?php echo e($countryName); ?>" <?php echo e(($company_data)?(($company_data->phone_number_country==$countryName)?'selected':''):''); ?>><?php echo e($countryName); ?> </option>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" name="message" placeholder="Please enter your message here..." rows="5" required><?php echo e(($company_data)?$company_data->message:''); ?></textarea>
                                </div>
                                <div class="form-group mb-4">
                                ...
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="crosstraing" value="Crosstraing" <?php echo e(($company_data)?(($company_data->crosstraing=="Crosstraing")?'checked':''):''); ?>>
                                        ...
                                        <div class="col-lg-4">
                                            <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="EMS" value="EMS" <?php echo e(($company_data)?(($company_data->EMS=="EMS")?'checked':''):''); ?>>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="Gym" value="Gym" <?php echo e(($company_data)?(($company_data->Gym=="Gym")?'checked':''):''); ?>>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="Gymnastics" value="Gymnastics" <?php echo e(($company_data)?(($company_data->Gymnastics=="Gymnastics")?'checked':''):''); ?>>
                                        ...
                                        <div class="col-lg-4">
                                            <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="karate" value="Karate" <?php echo e(($company_data)?(($company_data->karate=="Karate")?'checked':''):''); ?>>
                                                <span class="new-control-indicator"></span>Karate
                                            </label>
                                        </div>
                                        <div class="col-lg-4">
                                            <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="KickBoxing" value="KickBoxing" <?php echo e(($company_data)?(($company_data->KickBoxing=="KickBoxing")?'checked':''):''); ?>>
                                                <span class="new-control-indicator"></span>Kick Boxing
                                            </label>
                                        </div>
                                        <div class="col-lg-4">
                                        <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="MartialArts" value="MartialArts" <?php echo e(($company_data)?(($company_data->MartialArts=="MartialArts")?'checked':''):''); ?>>
                                                <span class="new-control-indicator"></span>Martial Arts
                                            </label>
                                        </div>
                                        <div class="col-lg-4">
                                            <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="mma" value="MMA" <?php echo e(($company_data)?(($company_data->mma=="MMA")?'checked':''):''); ?>>
                                                <span class="new-control-indicator"></span>MMA
                                            </label>
                                        </div>
                                        <div class="col-lg-4">
                                            <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="PersonalFitness" value="PersonalFitness" <?php echo e(($company_data)?(($company_data->PersonalFitness=="PersonalFitness")?'checked':''):''); ?>>
                                        ...
                                        <div class="col-lg-4">
                                        <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="Spinning" value="Spinning" <?php echo e(($company_data)?(($company_data->Spinning=="Spinning")?'checked':''):''); ?>>
                                                <span class="new-control-indicator"></span>Spinning
                                            </label>
                                        </div>
                                        <div class="col-lg-4">
                                            <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="weightlift" value="WeightLefting" <?php echo e(($company_data)?(($company_data->weightlift=="WeightLefting")?'checked':''):''); ?>>
                                ...
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="week_date[]" value="Monday" <?php echo e(($company_data)?(($company_data->week_date && in_array("Monday",json_decode($company_data->week_date))) ? "checked":""):''); ?>>
                                ...
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="week_date[]" value="Tuesday" <?php echo e(($company_data)?(($company_data->week_date && in_array("Tuesday",json_decode($company_data->week_date))) ? "checked":""):''); ?>>
                                ...
                                <div class="custom-control custom-checkbox">
                                    <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="week_date[]" value="Wednesday" <?php echo e(($company_data)?(($company_data->week_date && in_array("Wednesday",json_decode($company_data->week_date))) ? "checked":""):''); ?>>
                                ...
                                <div class="custom-control custom-checkbox">
                                    <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="week_date[]" value="Thursday" <?php echo e(($company_data)?(($company_data->week_date && in_array("Thursday",json_decode($company_data->week_date))) ? "checked":""):''); ?>>
                                ...
                                <div class="custom-control custom-checkbox">
                                     <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="week_date[]" value="Friday" <?php echo e(($company_data)?(($company_data->week_date && in_array("Friday",json_decode($company_data->week_date))) ? "checked":""):''); ?>>
                                ...
                                <div class="custom-control custom-checkbox">
                                     ...
                                     <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="week_date[]" value="Saturday" <?php echo e(($company_data)?(($company_data->week_date && in_array("Saturday",json_decode($company_data->week_date))) ? "checked":""):''); ?>>
                                ...
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="new-control new-checkbox checkbox-info">
                                                <input type="checkbox" class="new-control-input" name="week_date[]" value="Sunday" <?php echo e(($company_data)?(($company_data->week_date && in_array("Sunday",json_decode($company_data->week_date))) ? "checked":""):''); ?>>
                            ...
                            <div class="widget-header">                                
                             ...
                             <div class="widget-content widget-content-area">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="https://www.facebook.com/username/"  name="facebook" value="<?php echo e(($company_data)?$company_data->facebook:''); ?>">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="formGroupExampleInput">Twitter </label>
                                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="https://www.twitter.com/username/" name="twitter" value="<?php echo e(($company_data)?$company_data->twitter:''); ?>">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="formGroupExampleInput">Instagram </label>
                                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="https://www.instagram.com/username/" name="instagram" value="<?php echo e(($company_data)?$company_data->instagram:''); ?>">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="formGroupExampleInput">Youtube Video Link </label>
                                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="https://www.youtube.com/watch?v=" name="youtube" value="<?php echo e(($company_data)?$company_data->youtube:''); ?>">
                                </div>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\work\Gyms_PersonalTrainers\resources\views/user/myprofile.blade.php ENDPATH**/ ?>