                    ...
                    <table class="table  table-bordered" id="table1" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('admin.tourist_edit',$temp->id)); ?>"> <i class="im im-icon-Pencil"></i> </a>
                            </tr>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wa7ash23/public_html/vendor/resources/views/admin/tourist/tourist_table.blade.php ENDPATH**/ ?>