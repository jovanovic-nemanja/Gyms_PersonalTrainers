    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-md-16">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.update_gym')); ?>" method="post" enctype="multipart/form-data" class="dropzone" id="dropzone">
                        <?php echo csrf_field(); ?>
                        <input type="text" class="form-control" name="user_id" value="<?php echo e(($users)?$users->id:''); ?>" hidden>
                        <div class="form-body">
                            <!-- user first name -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            name="first_name" value="<?php echo e(($users)?$users->name:''); ?>" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            name="last_name" value="<?php echo e(($users)?$users->last_name:''); ?>" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Gym Name" id="gym_name" 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="inputAddress4"
                                                placeholder=" Email" name="email" value="<?php echo e(($users)?$users->email:''); ?>" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="inputAddress4"
                                            placeholder="Website" name="website" value="<?php echo e(($users)?$users->website:''); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <p class="form-control-static">
                                            <a href="<?php echo e(($document)?URL::asset('upload/documents/'.$document->document_path):route('myprofile.document')); ?>"><?php echo e(($document)?$document->document_path:'No document uploaded'); ?></a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-12">
                                        <textarea class="form-control resize_vertical" id="message1" name="message" placeholder="Please enter your message here..." rows="5" required>
                                            <?php echo e(($company_data)?$company_data->message:''); ?>
                ...
                <div class="card-body">
                    <div class="form-actions" style="bottom:0px;">
                        <button type="submit" class="btn btn-sm btn-primary" onclick="submit_fun()">Submit Profile</button>
                        <button type="submit" class="btn btn-sm btn-warning" onclick="reset_fun()">Reset</button>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wa7ash23/public_html/vendor/resources/views/admin/gym_edit.blade.php ENDPATH**/ ?>