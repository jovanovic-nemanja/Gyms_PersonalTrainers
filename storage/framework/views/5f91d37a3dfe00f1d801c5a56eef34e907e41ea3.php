...
My Branding ##parent-placeholder-3c6de1b7dd91465d437ef415f94f36afc1fbc8a8##
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
 <link rel="stylesheet" type="text/css" href="<?php echo e(asset('mytemp/plugins/select2/select2.min.css')); ?>">
<style>
    .custom-control{
        ...
        padding-bottom: 1px!important;
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-5 col-sm-12 layout-top-spacing">
                        ...
                        <div class="user-profile layout-spacing">
                                ...
                                <div class="text-center user-info">
                                    ...
                                    <div class="avatar avatar-xl">
                                        ...
                                        <div style=" display: inline-block;position: relative;width: 130px;height: 130px;overflow: hidden;border-radius: 50%;box-shadow:0px 0px 4px #cccccc;">
                                            ...
                                            <img alt="avatar" style="max-width:130px;min-height:130px;" src="<?php echo e(asset('img/images/card-pic1.jpg')); ?>" class="rounded-circle avatar_img" />
                                        
                                        </div>

                                    </div>

                                    <p style="color:black;" class="h6 mt-3 mb-0"><?php echo e(@$name->name == ''?auth()->user()->name:@$name->name); ?> <i data-feather="edit" style="width: 15px;" class="change_brand_name" data-name="<?php echo e(@$name->name); ?>"></i></p>
                                </div>
                            </div>
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="row">
                                    <?php $__currentLoopData = $youtube; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-lg-12 mb-2">
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" width="260" height="100" src="<?php echo e($v->name); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                                            </iframe>                                    
                                        </div>
                            ...
                            <div style="height:385px;" class="widget-content widget-content-area">
                                ...
                                <div class="row mt-2">
                                <?php $__currentLoopData = $certificates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <div class="col-lg-12 mb-2">
                                    
                                    <h6 style="font-size:14px;color:blue;"><?php echo e($v->name); ?></h6>
                                    <p style="font-size:12px;color:#393939;"><?php echo e(date('d M Y',strtotime($v->certificate_date))); ?></p>
                    ...
                    <div class="col-xl-9 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                        ...
                        <div class="layout-spacing">
                            <div class="widget-content widget-content-area">
                                ...
                                <form action="<?php echo e(route('save_brand_info')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                    <div style="margin-top:-10px;!important" class="">
                                        <h5 class="ml-1"><b>About Me</b></h5>
                                        <textarea class="form-control" name="about" placeholder="About me" rows="4"><?php echo e(@$about->about); ?></textarea>
                                    </div>
                                    <br>
                                        ...
                                        <div class="d-flex">
                                            <div class="n-chk">
                                                <label class="new-control new-radio radio-info">
                                                  <input type="radio" id="radio-all-controls" class="new-control-input" name="select_country_type" value="global" <?php echo e(@$about->select_country =='' || @$about->select_country == 'global'?'checked':''); ?>>
                                    ...
                                    <div class="radio">
                                        <div class="d-flex">
                                            <div class="n-chk">
                                                <label class="new-control new-radio radio-info">
                                                  <input type="radio" id="radio-minimal-black" class="new-control-input" name="select_country_type" value="selected" <?php echo e(@$about->select_country == 'selected'?'checked':''); ?>>
                                                  <span class="new-control-indicator"></span>
                                                    <span class="" style="color:black">
                                                        Select Countries
                                                    </span>
                                    ...
                                    ?>
                                    <div class="row pl-4 show_countries" style="display:<?php echo e($show_countries); ?>">
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-control tagging" multiple="multiple" name="selected_counrties[]">
                                                ...
                                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>:
                                                    ...
                                                    <option value="<?php echo e($code); ?>" <?php echo e($check == true?'selected':''); ?>><?php echo e($countryName); ?> </option>
            ...
            <div class="modal fade" id="UploadBrandPhotosModal">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-body">
                        ...
                        <form  action="<?php echo e(route('upload_brand_photos')); ?>" method="post" enctype="multipart/form-data" class="dropzone" id="dropzone">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
            ...
            <div class="modal fade" id="AddBrandsLinksModal">
                <div class="modal-dialog modal-lg">
                    ...
                    <!-- Modal body -->
                        <form action="<?php echo e(route('submit_brand_links')); ?>" method="post" >
                    <div class="modal-body">
            ...
            <div class="modal fade" id="AddBrandsCertificatesModal">
                <div class="modal-dialog modal-lg">
                    ...
                    <!-- Modal body -->
                        <form action="<?php echo e(route('submit_brand_certificates')); ?>" method="post" >
                    <div class="modal-body">
            ...
            <div class="modal fade" id="BrandNameModal">
                <div class="modal-dialog modal-lg">
                    ...
                    <!-- Modal body -->
                        <form action="<?php echo e(route('submit_brand_name')); ?>" method="post" >
                    <div class="modal-body">
...
<script src="<?php echo e(asset('mytemp/plugins/select2/select2.min.js')); ?>"></script>
<script src="<?php echo e(asset('mytemp/plugins/select2/custom-select2.js')); ?>"></script>
<script>
    ...
    Dropzone.options.dropzone =

        {
            ...
            removedfile: function (file) {
                ...
                $.ajax({
                    ...
                    url: '<?php echo e(route("brand_photos_delete")); ?>',
        ...
        function getBrandingData()
        {
            $.ajax({
                ...
                url : "<?php echo e(route('getBrandingData')); ?>",
                dataType : 'json',
                cache : false,
                async : true,
                success:function(data){
                    ...
                    if(images.length > 0)
                    {
                        ...
                        for(i=0; i < images.length; i++)
                        {
                            ...
                            let path = "<?php echo e(asset('')); ?>"+'/'+path_html;
                    ...
                    if(avatar.name != '')
                    {
                        ...
                        let path1 = "<?php echo e(asset('')); ?>"+'/'+path_html1;
        ...
        $('.delete_photos').click(function(){
            ...
            $.ajax({
                url : "<?php echo e(route('delete_brand_photos')); ?>",
                method : "post",
        ...
        $('#upload-image-form').submit(function(e) {
            ...
            $.ajax({
                type:'POST',
                url: '<?php echo e(route("submit_brand_image")); ?>',
                data: formData,
                contentType: false,
                processData: false,
                success:function(){
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.personal_default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/vendor.gymscanner.com/resources/views/vendor/my_branding.blade.php ENDPATH**/ ?>