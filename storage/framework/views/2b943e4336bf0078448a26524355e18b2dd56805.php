                    ...
                    <table class="table  table-bordered" id="table1" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('admin.document_edit',$temp->id)); ?>" class="mr-3"> <i class="im im-icon-Pencil"></i> </a>
                            </tr>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wa7ash23/public_html/vendor/resources/views/admin/document/document_table.blade.php ENDPATH**/ ?>