        ...
        <div class="card ">
            <div class="row ">
                    ...
                    <div class="row card-align bg-white" id="card_name">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <form class="d-inline" method="POST" action="<?php echo e(route('verification.resend')); ?>">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" class="btn btn-link p-0 m-0 align-baseline mt-15"><?php echo e(__('click here to request another')); ?></button>.
                                        </form>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 signup-form">
                            <img src="<?php echo e(asset('./login-pic.png')); ?>" class="img-responsive my-1 mr-1"  style="width:102%; height:97%;" >
                        </div>
                    </div>
                </div>
        </div>
...
<?php /**PATH /home/wa7ash23/public_html/vendor/resources/views/auth/verify.blade.php ENDPATH**/ ?>