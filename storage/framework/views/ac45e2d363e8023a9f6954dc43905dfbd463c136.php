...
<body>
    ...
    <script src="<?php echo e(asset('mytemp/plugins/apex/apexcharts.min.js')); ?>"></script>
    <script src="<?php echo e(asset('mytemp/assets/js/dashboard/dash_1.js')); ?>"></script>
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
      <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <script src="<?php echo e(asset('mytemp/assets/js/custom.js')); ?>"></script>
    <!-- END GLOBAL MANDATORY STYLES -->
...
<?php /**PATH /home/customer/www/vendor.gymscanner.com/resources/views/layouts/personal_default.blade.php ENDPATH**/ ?>