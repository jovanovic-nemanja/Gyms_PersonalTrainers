        ...
        <div class="card ">
            <div class="row ">
                    ...
                    <div class="row card-align bg-white" id="card_name">
                                        ...
                                        <form action="{{ route('login') }}" id="authentication" method="post"
                                            ...
                                            <div class="form-group">
                                                <div class="input-group mb-1">
                                                    ...
                                                    <input name="email" type="email" id="email" value="" class="form-control no-left-border" placeholder="Username" aria-describedby="email-addon" value="{{ old('email') }}" required>
                        ...
                        <div class="col-md-6 signup-form">
                            <img src="{{ asset('images/login-pic.png')}}" class="img-responsive my-1 pt-3 mr-1">
