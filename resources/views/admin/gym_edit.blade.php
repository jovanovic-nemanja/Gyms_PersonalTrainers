            ...
            <div class="row layout-top-spacing w-100">
                ...
                <!-- <div id="basic" class="col-lg-12 col-sm-12 col-12 layout-spacing"> -->
                    <div class="statbox widget box box-shadow w-100">
                        ...
                        <form  action="{{ route('admin.update_gym')}}" method="post" enctype="multipart/form-data" class="dropzone" id="dropzone">
                            @csrf
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput"  placeholder=" Email" name="email" value="{{($users)?$users->email:''}}" required>
                                </div>
                                <div class="form-group mb-4">
                                    <label for="formGroupExampleInput">Website</label>
                                    <input type="text" class="form-control" id="formGroupExampleInput"  placeholder="Website" name="website" value="{{($users)?$users->website:''}}">
                                </div>
                                <div class="form-group mb-4">
                                ...
                                <div class="form-group mb-4">
                                    <label for="formGroupExampleInput">DOCUMENT
                                     </label>
                                     <a href="{{($document)?URL::asset('upload/documents/'.$document->document_path):route('myprofile.document')}}">{{($document)?$document->document_path:'No document uploaded'}}</a>
                                </div>
                                <div class="form-group mb-4">
                            ...
                            <div class="widget-header">                                
                             ...
                             <div class="widget-content widget-content-area">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Facebook"  name="facebook" value="{{($company_data)?$company_data->facebook:''}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="formGroupExampleInput">Twitter </label>
                                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Twitter" name="twitter" value="{{($company_data)?$company_data->twitter:''}}">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="formGroupExampleInput">Instagram </label>
                                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Instagram" name="instagram" value="{{($company_data)?$company_data->instagram:''}}">
                                </div>
                                <div class="form-group mb-4">
