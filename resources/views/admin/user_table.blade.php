                    ...
                    <table class="table  table-bordered" id="table1" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('admin.user_edit',$temp->id)}}" class="mr-3"> <i class="im im-icon-Pencil"></i> </a>
                                    <a href="{{ route('admin.user_change_pass',$temp->id)}}" class="mr-3"> <i class="fas fa-key"></i> </a>
                                    @if($temp->role == 2) <a href="{{ route('admin.gym_delete', $temp->id)}}"> <i class="fa fa-trash "></i> </a></td>
                                    @else <a href="{{ route('admin.user_delete', $temp->id)}}"> <i class="fa fa-trash "></i> </a></td>
                                    @endif
                            </tr>
                            @endif
                            @endforeach
