                            ...
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('admin.tourist_edit',$temp->id)}}"  data-toggle="tooltip" data-placement="top" title="Edit" class="mr-3"> <i data-feather="edit-3"></i> </a>
                                    </tr>
                                    @endif
                                    @endforeach
